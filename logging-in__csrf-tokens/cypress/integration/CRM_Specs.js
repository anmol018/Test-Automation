...
let randtext;
  ...
  beforeEach(function(){
    ...
    it('Post Login, Company and Contact Creation', function(){		
		cy.request('/')
      .its('body')
      .then((body) => {
        ...
        cy.loginByCSRF(csrf)
          .then((resp) => {
            ...
            cy.get('.btn').click()
            //Add Company Details
            cy.get(':nth-child(2) > .pr40 > :nth-child(1) > :nth-child(2) > .ng-pristine').type(compn)
            cy.get(':nth-child(2) > .pr40 > :nth-child(2) > :nth-child(2) > .ng-pristine').type(compalias)
            cy.get('.pr40 > :nth-child(3) > :nth-child(2) > select-box.wid-100 > .wid-100 > .select2-choice > .select2-arrow > b').click()
            cy.get('.select2-container-active > .ui-select-dropdown').contains('Investor').click()
            cy.get('.pr40 > :nth-child(4) > :nth-child(2) > .fr > .relative > .wid-100 > .ml-auto').click()
            cy.get('.absolute').contains('Investor Sub 1').click()
            cy.get('.absolute > :nth-child(1) > .fr').click()
            cy.get(':nth-child(2) > .pr40 > :nth-child(5) > :nth-child(2) > .ng-pristine').type(randtext)
            cy.get(':nth-child(2) > .pr40 > :nth-child(6) > :nth-child(2) > .ng-pristine').type(tarea)
            cy.get(':nth-child(8) > :nth-child(2) > select-box.wid-100 > .wid-100 > .select2-choice > .select2-arrow > b').click()
            cy.get('.select2-container-active > .ui-select-dropdown > .search-container > .ui-select-search').type('Stadelhofen')
			...
			cy.get('.select2-container-active > .ui-select-dropdown').contains('Rex Rowbottom').click()
			...
			cy.get(':nth-child(12) > .input-group > .ng-untouched > .wid-100 > .ui-select-dropdown').contains('Pluto Finserv').click()
			//Adding Borrower
			cy.get(':nth-child(13) > .input-group > select-box.ng-pristine > .wid-100 > .select2-choice > .select2-arrow > b').click()
			...
			cy.get('.fl > .wid-100 > .ui-select-dropdown').contains('GBP').click()
			...
			cy.get('.fr > .wid-100 > .ui-select-dropdown > .ui-select-choices').contains('sqm').click()
			//Adding Market Value
			...
			cy.get(':nth-child(5) > :nth-child(7) > .ui-state-default').click()
			//Adding Date Listed
			...
			cy.get('.flex > .flex-1')
			  ...
			  cy.get('.icon-downArrow').click()
			  cy.get(':nth-child(2) > .noStyle > .m0 > .wid-100').click()
